		...
		<form action="${pageContext.request.contextPath}/sistema/fornecedor/salvar" method="POST">
			...
			<div class="row-fluid">
				...
				<div class="span3">
					...
					<input type="text" name="fornecedor.dataAbertura" value="${d}" readonly="readonly" placeholder="Data da abertura do cadastro">
					...
					<tbody>
						<c:forEach var="f" items="${fornecedores}">
							...
							<tr>
								...
								<td width="21" height="20"><a href="${pageContext.request.contextPath}/sistema/fornecedor/prepararEdicao?fornecedor.id=${f.id}"><img src="${pageContext.request.contextPath}/img/icone editar.jpg"></a></td>
								<td width="21" height="20"><a href="${pageContext.request.contextPath}/sistema/fornecedor/remover?fornecedor.id=${f.id}"><img src="${pageContext.request.contextPath}/img/icone excluir.jpg"></a></td>
							</tr>
							</pg:item>
						</c:forEach>
					</tbody>
